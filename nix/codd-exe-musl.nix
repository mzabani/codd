...
in
  rec {
    ...
    postgresql-libpq = muslPkgs.postgresql-libpq.components.library.overrideAttrs (_: {
          nativeBuildInputs = muslPkgs.postgresql-libpq.components.library.nativeBuildInputs ++ [ pkgs.pkgsCross.musl64.postgresql ];
        });
    
    postgresql-libpq-bad = muslPkgs.postgresql-libpq.components.library;
  }