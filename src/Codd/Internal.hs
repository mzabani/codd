                    ...
                    case lastException of
                        ...
                        Just MigrationApplicationFailure { noTxnMigRetryInstructions }
                            -> case noTxnMigRetryInstructions of
                                ...
                                Just (NoTxnMigMustRestartAfterSkipping numStmtsToSkip)
                                    -> do
                                        -- logDebug
...
newtype NoTxnMigFailureRetryInstructions = NoTxnMigMustRestartAfterSkipping Int
    deriving stock Show
...
applySingleMigration
    ...
    -> AddedSqlMigration m
    -> m AppliedMigration
applySingleMigration conn afterMigRun isolLvl numCountableRunnableStmtsToSkip (AddedSqlMigration sqlMig migTimestamp)
    = do
